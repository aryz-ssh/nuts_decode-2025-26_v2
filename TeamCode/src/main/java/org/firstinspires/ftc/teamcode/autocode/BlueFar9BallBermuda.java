...
import org.firstinspires.ftc.teamcode.autocode.pathingOnly.BlueFar9BallBermudaPathOnly;
import org.firstinspires.ftc.teamcode.pedroPathing.Constants;

@Autonomous(name = "Blue Bermuda Far 9 Ball", group = "Autonomous")
@Configurable
@Config
public class BlueFar9BallBermuda extends LinearOpMode {

    private TelemetryManager panelsTelemetry;
    private Follower follower;
    private BlueFar9BallBermudaPathOnly.RobotPaths paths;
    ...
    public static final double RAMP_ANGLE = Mechanisms.RAMP_ANGLE_MIN_POS;
    ...
    public void runOpMode() {
        ...
        paths = new BlueFar9BallBermudaPathOnly.RobotPaths(follower);
        ...
        while (!isStarted() && !isStopRequested()) {
            ...
            telemetry.addData("Motif Locked", motifLocked);
            telemetry.update();
        }

        waitForStart();

        AutoState state = AutoState.DRIVE_TO_SHOOT_POS;
