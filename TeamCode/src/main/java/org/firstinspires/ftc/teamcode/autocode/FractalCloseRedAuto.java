...
@Configurable
public class FractalCloseRedAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        follower.setStartingPose(new Pose(120.88683602771363, 126.3741339491917, Math.toRadians(36)));
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ToShoot = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(120.88683602771363, 126.3741339491917), new Pose(86.63279445727483, 132.69284064665126))
                    )
            ...
            moveAway = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(86.63279445727483, 132.69284064665126), new Pose(78.48498845265588, 135.35334872979215))
                    )
