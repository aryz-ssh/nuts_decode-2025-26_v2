...
public class NewRedFarAuto extends LinearOpMode {
    ...
    NewRedFarAuto.AutoState autoState =
            NewRedFarAuto.AutoState.WAIT_FOR_HOME;
    ...
    public void runOpMode() {
        ...
        autoState = NewRedFarAuto.AutoState.START_TO_SHOOT;

        while (opModeIsActive()) {
            if (autoState != NewRedFarAuto.AutoState.WAIT_FOR_HOME) {
                follower.update();
            }
            ...
            switch (autoState) {
                case START_TO_SHOOT:
                    ...
                    autoState = NewRedFarAuto.AutoState.WAIT_TO_SHOOT;
                    break;
                ...
                case START_OUTTAKE:
                    ...
                    autoState = NewRedFarAuto.AutoState.RAMP_UP;
                    break;

                case WAIT_TO_SHOOT:
                    if (!follower.isBusy()) {
                        autoState = NewRedFarAuto.AutoState.START_OUTTAKE;
                    }
                    break;
                ...
                case RAMP_UP:
                    if (stateTimer.seconds() >= RAMP_UP_TIME) {
                        ...
                        autoState = NewRedFarAuto.AutoState.MOVE_SORTER;
                    }
                    break;
                ...
                case MOVE_SORTER:
                    ...
                    autoState = NewRedFarAuto.AutoState.WAIT_SORTER;
                    break;

                case WAIT_SORTER:
                    if (!isSorterMoving()) {
                        stateTimer.reset();
                        autoState = NewRedFarAuto.AutoState.SORTER_SETTLE;
                    }
                    break;

                case SORTER_SETTLE:
                    if (stateTimer.seconds() >= SORTER_SETTLE_TIME) {
                        autoState = NewRedFarAuto.AutoState.KICK_1;
                    }
                    break;
                ...
                case KICK_1:
                    ...
                    stateTimer.reset();
                    autoState = NewRedFarAuto.AutoState.WAIT_1;
                    break;

                case WAIT_1:
                    if (stateTimer.seconds() >= FIRST_KICK_DELAY) {
                        autoState = NewRedFarAuto.AutoState.KICK_2;
                    }
                    break;
                ...
                case KICK_2:
                    mechanisms.ejectBall();
                    stateTimer.reset();
                    autoState = NewRedFarAuto.AutoState.WAIT_2;
                    break;

                case WAIT_2:
                    if (stateTimer.seconds() >= SECOND_KICK_DELAY) {
                        autoState = NewRedFarAuto.AutoState.NEXT_POCKET;
                    }
                    break;
                ...
                case NEXT_POCKET:
                    ...
                    if (currentPocket > 3) {
                        ...
                        autoState = NewRedFarAuto.AutoState.START_MOVE_AWAY;
                    } else {
                        autoState = NewRedFarAuto.AutoState.MOVE_SORTER;
                    }
                    break;
                ...
                case START_MOVE_AWAY:
                    ...
                    autoState = NewRedFarAuto.AutoState.WAIT_MOVE_AWAY;
                    break;

                case WAIT_MOVE_AWAY:
                    if (!follower.isBusy()) {
                        autoState = NewRedFarAuto.AutoState.RETURN_TO_INTAKE;
                    }
                    break;
                ...
                case RETURN_TO_INTAKE:
                    ...
                    autoState = NewRedFarAuto.AutoState.WAIT_RETURN_TO_INTAKE;
                    break;

                case WAIT_RETURN_TO_INTAKE:
                    if (!isSorterMoving()) {
                        autoState = NewRedFarAuto.AutoState.DONE;
                    }
                    break;
