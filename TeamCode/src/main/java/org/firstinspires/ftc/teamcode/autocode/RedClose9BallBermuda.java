...
public class RedClose9BallBermuda extends LinearOpMode {
    ...
    private RedClose9BallBermudaPathOnly.RobotPaths paths;
...
//        }
    ...
    public void runOpMode() {
        ...
        paths = new RedClose9BallBermudaPathOnly.RobotPaths(follower);
...
//                    break;
                ...
                case DRIVE_TO_SHOOT_POS:
                    ...
                    if (!follower.isBusy()) {
                        ...
                        aprilTagLimelight.setPipeline(GOAL_PIPELINE);
