...
@Autonomous(name = "Leave Far Forward", group = "Autonomous")
@Config
public class FarFowardLeave extends LinearOpMode {
    ...
    // End pose
    public static double END_X = 56.2;
    public static double END_Y = 30.4;
