    ...
    public static class RobotPaths {
        ...
        public RobotPaths(Follower follower) {
            shootPreload = follower.pathBuilder().addPath(
                            new BezierLine(
                                    new Pose(91.849, 8.000),

                                    new Pose(81.876, 20.953)
                            )
